...
# Global hotkey support was removed in v2.9.1 — kept too narrow a benefit
# for the third-party install footprint. If you want a hotkey, set up your
# own AutoHotkey or PowerToys Run shortcut pointing at `brief` (which is
# now on PATH).
