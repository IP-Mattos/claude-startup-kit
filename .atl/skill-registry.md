# Skill Registry — claude-startup-kit
...
- C:\Users\DemonTwo\.agents\skills
- C:\Users\DemonTwo\.claude\skills
- C:\Users\DemonTwo\.copilot\skills
...
### agent-browser
- Path: C:\Users\DemonTwo\.claude\skills\agent-browser\SKILL.md
- Rules:
...
### astro
- Path: C:\Users\DemonTwo\.agents\skills\astro\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### brainstorming
- Path: C:\Users\DemonTwo\.claude\skills\brainstorming\SKILL.md
...
### branch-pr
- Path: C:\Users\DemonTwo\.claude\skills\branch-pr\SKILL.md
...
### chained-pr
- Path: C:\Users\DemonTwo\.claude\skills\chained-pr\SKILL.md
...
- Path: C:\Users\DemonTwo\.claude\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\DemonTwo\.claude\skills\comment-writer\SKILL.md
...
### find-skills
- Path: C:\Users\DemonTwo\.claude\skills\find-skills\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### frontend-design
- Path: C:\Users\DemonTwo\.claude\skills\frontend-design\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: C:\Users\DemonTwo\.claude\skills\go-testing\SKILL.md
...
### init-pro-agent
- Path: C:\Users\DemonTwo\.claude\skills\init-pro-agent\SKILL.md
- Trigger: Use when the user says "inicio modo pro-agent", "activa pro-agent", "pro-agent" or wants to initialize the SDD workflow in a new project. Sets up skill-registry and openspec structure automatically.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### issue-creation
- Path: C:\Users\DemonTwo\.claude\skills\issue-creation\SKILL.md
...
### judgment-day
- Path: C:\Users\DemonTwo\.claude\skills\judgment-day\SKILL.md
...
- Path: C:\Users\DemonTwo\.claude\skills\laravel-best-practices\SKILL.md
- Trigger: Laravel 11 best practices — Eloquent patterns, controllers, validation, authorization, testing with Pest, and Blade/Tailwind conventions. Use when working on Laravel/PHP projects.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### next-best-practices
- Path: C:\Users\DemonTwo\.claude\skills\next-best-practices\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### security-best-practices
- Path: C:\Users\DemonTwo\.claude\skills\security-best-practices\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: C:\Users\DemonTwo\.claude\skills\skill-creator\SKILL.md
...
- Path: C:\Users\DemonTwo\.claude\skills\supabase-postgres-best-practices\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### threejs-animation
- Path: C:\Users\DemonTwo\.agents\skills\threejs-animation\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### trading-filter-audit
- Path: C:\Users\DemonTwo\.claude\skills\trading-filter-audit\SKILL.md
- Trigger: >
- Rules:
  - Data source: Safe to join?
  - Snap-time corpus: ✅
  - Backward-looking regime samples (with `bisect_right` lookup): ✅
  - Enrichment built from later events (e.g. fires that happen post-snap): ❌
  - Resolution outcomes: ✅ as labels only
  - Wait for regime to shift and re-validate
  - Add explicit regime gate to filter

### ui-animation
- Path: C:\Users\DemonTwo\.agents\skills\ui-animation\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### ui-ux-pro-max
- Path: C:\Users\DemonTwo\.claude\skills\ui-ux-pro-max\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### vercel-react-best-practices
- Path: C:\Users\DemonTwo\.claude\skills\vercel-react-best-practices\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### web-design-guidelines
- Path: C:\Users\DemonTwo\.claude\skills\web-design-guidelines\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: C:\Users\DemonTwo\.claude\skills\work-unit-commits\SKILL.md
