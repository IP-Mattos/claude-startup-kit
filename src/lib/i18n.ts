...
const STRINGS = {
  ...
  "nav.trello": { en: "Board", es: "Tablero" },
  ...
  // Trello board view — kanban over the trello-equipo API (projects →
  // columns → tasks), full CRUD with drag & drop + live updates.
  "trello.title": { en: "Board", es: "Tablero" },
  "trello.subtitle": { en: "Your team board", es: "Tu tablero de equipo" },
  "trello.config_subtitle": {
    en: "Connect your trello-equipo API to manage tasks here.",
    es: "Conectá tu API de trello-equipo para gestionar tareas acá.",
  },
  "trello.desktop_only": {
    en: "The board is only available in the desktop app.",
    es: "El tablero solo está disponible en la app de escritorio.",
  },
  "trello.api_key": { en: "API key", es: "API key" },
  "trello.base_url": { en: "Base URL (optional)", es: "Base URL (opcional)" },
  "trello.base_url_hint": {
    en: "Leave blank to use the default production URL.",
    es: "Dejalo vacío para usar la URL de producción por defecto.",
  },
  "trello.connect": { en: "Connect", es: "Conectar" },
  "trello.connecting": { en: "Connecting…", es: "Conectando…" },
  "trello.security_note": {
    en: "The key is stored locally (~/.claude/trello.json, owner-only) and never committed. Rotate it if it has been exposed.",
    es: "La key se guarda local (~/.claude/trello.json, solo dueño) y nunca se commitea. Rotala si quedó expuesta.",
  },
  "trello.loading": { en: "Loading…", es: "Cargando…" },
  "trello.loading_board": { en: "Loading board…", es: "Cargando tablero…" },
  "trello.project": { en: "Project", es: "Proyecto" },
  "trello.no_projects": { en: "No projects", es: "Sin proyectos" },
  "trello.no_columns": {
    en: "This project has no columns yet.",
    es: "Este proyecto todavía no tiene columnas.",
  },
  "trello.no_tasks": { en: "No tasks", es: "Sin tareas" },
  "trello.disconnect": { en: "Disconnect", es: "Desconectar" },
  "trello.live_on": { en: "Live", es: "En vivo" },
  "trello.live_connecting": { en: "Connecting…", es: "Conectando…" },
  "trello.live_error": { en: "Live error", es: "Error en vivo" },
  "trello.live_off": { en: "Offline", es: "Sin conexión" },
  "trello.lag": {
    en: "More changes pending — refreshing…",
    es: "Hay más cambios pendientes — refrescando…",
  },
  "trello.notice_supervisor": {
    en: "Marked complete, but a supervisor still has to approve it.",
    es: "Marcada como completa, pero falta que un supervisor la apruebe.",
  },
  "trello.add_task": { en: "Add task", es: "Agregar tarea" },
  "trello.complete": { en: "Complete", es: "Completar" },
  "trello.assignees": { en: "Assignees", es: "Asignados" },
  "trello.comments": { en: "Comments", es: "Comentarios" },
  "trello.new_task": { en: "New task", es: "Nueva tarea" },
  "trello.edit_task": { en: "Edit task", es: "Editar tarea" },
  "trello.export": { en: "Export JSON", es: "Exportar JSON" },
  "trello.export_title": { en: "Export tasks to JSON", es: "Exportar tareas a JSON" },
  ...
  "trello.field_date": { en: "Date", es: "Fecha" },
  "trello.field_column": { en: "Column", es: "Columna" },
  "trello.field_progress": { en: "Progress", es: "Progreso" },
  "trello.create": { en: "Create", es: "Crear" },
  "trello.delete": { en: "Delete", es: "Eliminar" },
  "trello.confirm_delete": { en: "Confirm delete", es: "Confirmar" },
  "trello.conflict_warning": {
    en: "This task changed elsewhere since you opened it. Saving will overwrite the fields you edited.",
    es: "Esta tarea cambió en otro lado desde que la abriste. Guardar va a sobrescribir los campos que editaste.",
  },
  "trello.save_anyway": { en: "Save anyway", es: "Guardar igual" },
  "trello.busy_hint": {
